...
import { GetAllHouseRulesDTO } from './GetAllHouseRulesDTO';
...
export class GetAllHouseRulesUseCase
  implements UseCase<GetAllHouseRulesDTO.Request, GetAllHouseRulesDTO.Response>
{
  ...
  public async execute(
    dto: GetAllHouseRulesDTO.Request
  ): Promise<GetAllHouseRulesDTO.Response> {
    try {
      const call = await this.houseRuleService.getAllHouseRulesService(dto);
      const res = {
